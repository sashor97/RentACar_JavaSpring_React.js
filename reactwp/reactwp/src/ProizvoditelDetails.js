...
function ProizvoditelDetails({match}) {
    ...
    const fetchItems = async () => {
        const data = await fetch(
            `http://localhost:8080/vozilo/proizvoditel/${match.params.id}`
        );
    ...
    return (
        <div>
            <h2>Vozila od izbraniot proizvoditelot</h2>
            ...
            <br/>
            <Link to='/proizvoditeli'>Nazad kon proizvoditeli </Link>

        </div>
    )
}

export default ProizvoditelDetails;